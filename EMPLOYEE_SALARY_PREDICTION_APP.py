...
# Sidebar inputs (these must match your training feture columns)
...
occupation = st.sidebar.selectbox("Job Role", [
    ...
    "Exec-managerial", "Prof-speciality", "Handlers-cleaners", "Machine-op-inspct",
...
# streamlit run "(path of this file)"
