...
# --- Predicting New House Price Based on User Input ---
print("\n Predict Median House Value for a New Neighborhood:")
...
try:
    ...
    predicted_value = rf_regressor.predict(input_array)[0]  # in units of $100,000

    print(f"\n🔮 Predicted Median House Value: ${predicted_value * 1e5:,.2f}")
